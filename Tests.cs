...
namespace BottlesProject
{
    ...
    public class BottlesTest
    {
        ...
        public void TestTheFirstVerse()
        {
            ...
            Assert.AreEqual(expected, new Bottles().Verse(99));
        }
        ...
        public void TestAnotherVerse()
        {
            ...
            Assert.AreEqual(expected, new Bottles().Verse(3));
        }
        ...
        public void TestVerse2()
        {
            ...
            Assert.AreEqual(expected, new Bottles().Verse(2));
        }
        ...
        public void TestVerse1()
        {
            ...
            Assert.AreEqual(expected, new Bottles().Verse(1));
        }
        ...
        public void TestVerse0()
        {
            ...
            Assert.AreEqual(expected, new Bottles().Verse(0));
        }
        ...
        public void TestACoupleOfVerses()
        {
            ...
            Assert.AreEqual(expected, new Bottles().Verses(99, 98));
        }
        ...
        public void TestAFewVerses()
        {
            ...
            Assert.AreEqual(expected, new Bottles().Verses(2, 0));
        }
...
";
            ...
            Assert.AreEqual(expected, new Bottles().Song());
        }
    }
}